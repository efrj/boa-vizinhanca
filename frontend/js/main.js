document.addEventListener('alpine:init', () => {
    Alpine.data('neighborhood', () => ({
        ...
        characters: [
            ...
            { id: 11, name: 'Carteiro Jaiminho', port: 8010, lang: 'Shell Script', avatar: '/img/jaiminho.png', langLogo: '/img/sh.png', phrase: 'Carregando...', loading: true, status: 'loading', style: 'card-theme-jaiminho' },
